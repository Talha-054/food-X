    ...
    <>
        <div className='p-[3em] xl:pb-0 flex justify-evenly items-center bg-[#1b1b1b]'>
            <div className='flex flex-col justify-center items-center gap-1'>
                <span className='bg-[#826A45] p-3 lg:p-4 rounded-full'><FaPhone color='white' fontSize={35}/></span>
                <h3 className='text-[#FFFFFF] text-[16px] font-medium'>Hotline</h3>
                <h3 className='text-[#FFFFFF] text-[12px] font-normal'>+49723658349</h3>
            </div>
            <div className='flex flex-col justify-center items-center gap-1'>
                <span className='bg-[#826A45] p-3 lg:p-4 rounded-full'><FaMapMarkedAlt color='white' fontSize={35}/></span>
                <h3 className='text-[#FFFFFF] min-w-[94px] text-[16px] font-medium'>Our Location</h3>
                <h3 className='text-[#FFFFFF] text-[12px] font-light'>+49723658349</h3>
            </div>
            <div className='flex flex-col justify-center items-center gap-1'>
                <span className='bg-[#826A45] p-3 lg:p-4 rounded-full'><MdEmail color='white' fontSize={35}/></span>
